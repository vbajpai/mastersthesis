...
A formalized Flowy query to identify Skype failure signature for NAT$64$ is described in listing \ref{lst:skypefailure} for an instance. The filter sections of each branch are shown separately in listings \ref{lst:skypefailurebranchA} and \ref{lst:skypefailurebranchB}. 
