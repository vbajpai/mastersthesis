...
The ever increasing traffic volume crossing high-speed links, has been creating an enormous pressure on the routers that also engaged in NetFlow export. Sampled NetFlow was thus introduced \marginpar{sampled netflow} to tone down the gigantic computation, by allowing them to skip over to every $n^{th}$ packet for flow export. The sampling rate is indicated in the export header and be configured on the fly.
