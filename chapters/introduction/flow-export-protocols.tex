...
The transmission of records encapsulated in \ac{UDP} datagrams can lead to loss of flows when the link is congested and therefore the exporter and collector have usually \marginpar{netflow v9} been restricted to one-hop away dedicated links. To overcome this limitation, NetFlow v$9$ introduced transport support over congestion-aware \ac{SCTP}. 
