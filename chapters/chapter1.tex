...
needed packages. Furthermore, \texttt{thesis} 
...
now use the style stand-alone via the file \texttt{thesis.sty}.
This works now also with ``plain'' \LaTeX.

As of version 3.0, \texttt{thesis} can also be easily used with 
...
\begin{itemize}
    ...
    separate files such as \texttt{chapter1.tex} etc.
 %  \item\texttt{Examples/} is where you store all listings and other
 %  examples you want to use for your text.
    \item\texttt{frontback/} is where all the stuff goes that
    ...
    \item\texttt{thesis.sty}: the style definition to get this
    awesome look and feel. Does not only work with this thesis template
    but also on its own (see folder \texttt{Examples}). Bonus: works
    with both \LaTeX\ and \textsc{pdf}\LaTeX\dots and LyX.
    \item\texttt{thesis.tcp} a \TeX nicCenter project file.
    Great tool and it's free!
    \item\texttt{thesis.tex}: the main file of your thesis
    where all gets bundled together.
    \item\texttt{thesis-preamble.sty}: a central place to load all 
    ...
    specify here the options you want to load \texttt{thesis.sty} 
...
There are a couple of options for \texttt{thesis.sty} that
...
\begin{itemize}
  ...
  \item Typography:
    ...
    all floats such as figures, tables, and listings (if used).	
	    ...
	    package. Use this option if you want use thesis with the
...
\texttt{thesis} to your needs.

The file \texttt{thesis.sty}
...
the data in the following lines of \texttt{thesis-preamble.sty:}%
...
Further customization can be made in \texttt{thesis-preamble.sty}
by choosing the options to \texttt{thesis.sty} 
(see~\autoref{sec:options}) in a line that looks like this:


\begin{lstlisting}[frame=lt]
\PassOptionsToPackage{eulerchapternumbers,drafting,listings,subfig,eulermath,parts}{thesis}
\end{lstlisting}
...
\PassOptionsToPackage{backref}{thesis-preamble} 
\end{lstlisting}


Many other customizations in \texttt{thesis-preamble.sty} are
possible, but you should be careful making changes there, since some
changes could cause errors.

Finally, changes can be made in the file \texttt{thesis.sty},%
\marginpar{Modifications in \texttt{thesis.sty}%
...
Beta versions of \texttt{thesis} can be found at the following 
Google code repository:
\begin{center}
	\url{http://code.google.com/p/thesis/}
\end{center}
...
It is easy to use the layout of \texttt{thesis.sty} without the
...
%\texttt{thesis.sty} and \texttt{bibliography.bib} within the 
%examples.)

% \lstinputlisting[caption=An Article]%
%     {Examples/thesis-article.tex}
%     
% \lstinputlisting[caption=A Book]%
%     {Examples/thesis-book.tex}
% 
% \lstinputlisting[caption=A Curriculum Vit\ae]%
%     {Examples/thesis-cv.tex}
