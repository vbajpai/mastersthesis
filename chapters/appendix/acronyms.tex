...
\begin{acronym}[UML]
    ...
    \acro{HDF}{Hierarchical Data Format}
		...
		\acro{IE}{Information Elements}
		\acro{IANA}{Internet Assigned Numbers Authority}
		\acro{PENs}{Private Enterprise Numbers}
		\acro{EP}{Exporter Process}
		\acro{CP}{Collector Process}
		\acro{ACKs}{Acknowledgements}
		\acro{SMI}{Structure of Managed Information}
